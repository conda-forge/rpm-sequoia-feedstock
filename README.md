...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/rpm-sequoia-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rpm-sequoia-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add rpm-sequoia
# for installing globally
pixi global install rpm-sequoia
```
...
It is possible to list all of the versions of `rpm-sequoia` available on your platform:
...
```
pixi search rpm-sequoia --channel conda-forge
```
